...
prefix <- "PfNov24" # Prefix for plink files
metadata <- "/mnt/storage13/nbillows/Pf_09_24/Pfalciparum_09_24_v2/analysis_09_24_v2/Pf_Nov24_metadata_complete.csv" # File path to metadata
...
desc <- id %>% left_join(met, by = c("V1" = "wgs_id"))
